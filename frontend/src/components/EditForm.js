import { AutoComplete, Button, Cascader, Checkbox, Col, Form, Input, InputNumber, Row, Select, notification } from "antd"
  ...
  return (
    ...
    >
      ...
      <Form.Item
        ...
        hasFeedback
      >
        <Cascader options={optionBloodType} placeholder="Pilih golongan darah pasien" />
      </Form.Item>
      ...
      <Form.Item
        ...
        hasFeedback
      >
        <Cascader options={optionDonorType} placeholder="Pilih tipe donor darah" />
      </Form.Item>
